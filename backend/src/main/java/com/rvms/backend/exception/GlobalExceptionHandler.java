...
import com.rvms.backend.dto.common.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleVehicleUnavailable(VehicleNotAvailableException ex, HttpServletRequest req) {
